...
def run_force_pred(input_files='input_files', 
    ...
    np.savetxt('molecule_c.dat', (molecule.coords[start:end]).reshape(-1,3))
    np.savetxt('molecule_f.dat', (molecule.forces[start:end]).reshape(-1,3))
    np.savetxt('molecule_e.dat', (molecule.energies[start:end]).reshape(-1,1))
    np.savetxt('molecule_q.dat', (molecule.mat_FE[start:end]).reshape(-1,_NC2))
    np.savetxt('molecule_bias.dat', (molecule.mat_bias[start:end]).reshape(-1,_NC2))
    sys.exit()
    '''
