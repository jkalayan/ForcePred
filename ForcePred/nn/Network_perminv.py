...
class Network(object):
    ...
    def get_coord_FE_model(self, molecule, prescale1):
        ...
        for l in range(0, max_depth):
            ...
            #net_layer = Dense(units=_NC2, activation='sigmoid', 
                    #name='net_layer')(sumNRF_layer)
            ...
            qpairs = GetQ(n_atoms, _NC2, name='qpairs')([coords_layer, 
                    dE_dx, sumNet_layer])
        ...
        if fit:
            best_error = model.evaluate(train_input_coords, 
                    [train_forces, 
                        #train_output_atomFE, 
                        train_output_matFE,
                        train_output_E_postscale], verbose=0)
