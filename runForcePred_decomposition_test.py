...
def run_force_pred(input_files='input_files', 
        ...
        bias='bias', filtered='filtered', load_model='load_model', 
    ...
    if atom_file or list_files:
        ...
        Converter.get_qE_from_qF(molecule, 
                bias_type=bias, extra_cols=extra_cols)
...
def main():
    ...
    run_force_pred(input_files=op.input_files, atom_file=op.atom_file, 
            ...
            bias=op.bias, filtered=op.filtered, load_model=op.load_model, 
